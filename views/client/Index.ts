...
document.addEventListener("keydown", function (event) {
    ...
    if (key) {
        ...
        switch (key) {
            case Movement.Right: client.player.position.velocity.target.x = 30; break;
            case Movement.Left: client.player.position.velocity.target.x = -30; break;
            case Movement.Up: client.player.position.velocity.target.y = -30; break;
            case Movement.Down: client.player.position.velocity.target.y = 30; break;
        }
